...
public class dividiryvencer {
    ...
    public static void main(String[] args) {
        ...
        //captura de datos
        System.out.println("ingrese el numero inicial el rango: ");
        Double inicial=reader.nextDouble();
        //captura de datos
        System.out.println("ingrese el numero final del rango  el rango: ");
        Double _final=reader.nextDouble();
        //impresion de respuestas ed validación de calculo
        System.out.println(new logica().dividiryvencerLogica(inicial,_final,Ecuacion)); //este es el rango correcto
//        System.out.println(new logica().dividiryvencerLogica(0.0,10.0,Ecuacion)); //este es el rango correcto
//
//        System.out.println(new logica().dividiryvencerLogica(1.0,5.0,Ecuacion));
//        System.out.println(new logica().dividiryvencerLogica(20.0,30.0,Ecuacion));
//        System.out.println(new logica().dividiryvencerLogica(1.0,10.0,Ecuacion)); //este es el rango correcto
//        System.out.println(new logica().dividiryvencerLogica(-10.0,-1.0,Ecuacion)); //este es el rango correcto
...
class logica
{
    public Double dividiryvencerLogica( Double a, Double b, Function<Double, Double> func)
    {
        ...
        System.out.println("el rango no tiene raiz en el limite cero");
        return 0.0;
    }
